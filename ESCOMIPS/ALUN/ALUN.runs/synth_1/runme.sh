...
HD_PWD='C:/Users/Aaron/Desktop/PYARQUI/ALUN/ALUN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Alu_16bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Alu_16bits.tcl
