...
type arreglo is array ( 0 to (2**8) -1) of std_logic_vector(24 downto 0);
constant aux : arreglo := (
------------------------------------------------------------------------
--           Programa Proyecto 0 Sumador unitario indefinido
------------------------------------------------------------------------
    -- LI & R0 & x"0001",
    -- LI & R1 & x"0007",
...
------------------------------------------------------------------------
--           Programa Proyecto 1 Llenar arreglo en meoria de 10 
--       localidades con numeros impares descendentes a partir de 5 
------------------------------------------------------------------------
    LI & R1 & x"0000", -- 0
    LI & R2 & x"000A", -- 1
    LI & R3 & x"0037", -- 2
