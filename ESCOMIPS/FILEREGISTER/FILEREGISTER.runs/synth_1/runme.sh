...
HD_PWD='C:/Users/Aaron/Desktop/PYARQUI/FILEREGISTER/FILEREGISTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Archivo_Registro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Archivo_Registro.tcl
