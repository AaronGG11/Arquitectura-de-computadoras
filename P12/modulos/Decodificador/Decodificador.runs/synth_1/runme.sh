...
HD_PWD='C:/Users/Aaron/Desktop/P12/Decodificador/Decodificador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decodificador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decodificador.tcl
